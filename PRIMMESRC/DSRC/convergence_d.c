...
#include "convergence_private_d.h"
#include "ortho_d.h"
 ...
 ******************************************************************************/
static int check_practical_convergence(double *R, int nLocal, int ldR,
   double *evecs, int evecsSize, int ldevecs, int left, int *iev,
   int numToProject, int *flags, double *blockNorms, double tol, double *rwork,
